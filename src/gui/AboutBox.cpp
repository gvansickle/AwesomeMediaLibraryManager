...
AboutBox::AboutBox(QWidget *parent, const Qt::WindowFlags &flags) : QDialog(parent, flags)
{
    ...
    m_text_str
        = tr("<body>"
             ...
             "<hr>"
             "<p><a "
             "href=\"https://github.com/gvansickle/"
             "AwesomeMediaLibraryManager\">AwesomeMediaLibraryManager</a> is free software: you "
             ...
             " along with AwesomeMediaLibraryManager.  If not, see <a "
             "href=\"http://www.gnu.org/licenses/\">http://www.gnu.org/licenses/</a>.</p>"
             "<hr>"
             "</body>")
              .arg(app_name_str, app_full_version_info);
