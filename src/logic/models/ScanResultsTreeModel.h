 ...
 */
class ScanResultsTreeModel : public /*ThreadsafeTreeModel*/AbstractTreeModel, public virtual ISerializable, public enable_shared_from_this_virtual<ScanResultsTreeModel>
{
	Q_OBJECT
